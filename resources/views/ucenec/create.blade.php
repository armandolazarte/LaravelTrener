...
@section('meniSredina')
    <ul class="breadcrumb">
        ...
        <li class="active">{!! trans('meni/ucenci.nov-ucenec_novo') !!}</li>
    </ul>
@endsection
...
@section('content')
    ...
    <div class="page-title">
        <h2><span class="fa fa-users"></span> {!! trans('meni/ucenci.nov-ucenec_novo') !!} </h2>
    </div>
    <div class="page-content-wrap">

        <div class="row">
            <div class="col-md-12">
                {!! Form::open(['route' => 'ucenec.store', 'files' => 'true', 'class' => 'form-horizontal']) !!}
                <div class="panel panel-default">


                    @include('ucenec/partials/_form', ['submitButtonText' =>  trans('meni/ucenci.poslji'), 'vrednost'=> 1,  'naslovniTekst' => '<strong>' .trans('meni/meni.nov') .'</strong> ' .trans('meni/ucenci.trener_dva')])
