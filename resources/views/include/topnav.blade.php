<ul class="x-navigation x-navigation-horizontal x-navigation-panel">
    ...
    <li class="xn-icon-button pull-right last">
        ...
        <ul class="xn-drop-left animated zoomIn">
            <li><a href="pages-lock-screen.html"><span class="fa fa-lock"></span> {!! trans('login/login.lokscreen') !!}</a></li>
            <li><a href="#" class="mb-control" data-box="#mb-signout"><span class="fa fa-sign-out"></span> {!! trans('login/login.logout') !!}</a></li>
        </ul>
    </li>
    <!-- END POWER OFF -->
    <!-- MESSAGES -->
    ...
    <!-- LANG BAR -->
    <li class="xn-icon-button pull-right">
        <a href="#"><span class="flag flag-si"></span></a>
        <ul class="xn-drop-left xn-drop-white animated zoomIn">
            <li><a href="#"><span class="flag flag-si"></span> Slovensko</a></li>
